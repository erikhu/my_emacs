...
before packages are loaded."
  (setq user-full-name "Erik Gonzalez"
        user-mail-address "erikhuboy@gmail.com")
  (setq flycheck-elixir-credo-strict t)
  (put 'flycheck-elixir-credo-executable 'safe-local-variable #'stringp)
  (setq git-messenger:show-detail t)
  (setq treemacs-position 'right)
  (define-key evil-normal-state-map (kbd "C-x C-j t") 'dumb-jump-go)
  (define-key evil-normal-state-map (kbd "C-x C-j b") 'dumb-jump-back)
  (define-key evil-normal-state-map (kbd "SPC g g") 'magit)
  (define-key evil-normal-state-map (kbd "C-x C-j w") 'dumb-jump-go-other-window)
  (spacemacs/set-leader-keys "aa" 'aidermacs-transient-menu) ; Example binding SPC a a
  ;; (add-hook 'elixir-mode-hook 'elixir-ts-mode)
  ;; (add-hook 'elixir-mode-hook 'heex-ts-mode)
  (add-hook 'elixir-mode-hook 'exunit-mode)
  ;;(add-hook 'lsp-mode-hook 'copilot-mode)
  (setq lsp-enable-file-watchers t)
  (setq lsp-lens-enable t)
  (setq lsp-elixir-ls-version "v0.27.2")
  (setq lsp-elixir-local-server-command "/Users/erik.cardona/Downloads/elixir-ls-v0.27.2/language_server.sh")
  ;; Copilot
  ...
  ;;   (define-key copilot-completion-map (kbd "C-<tab>") 'copilot-accept-completion-by-word))
  ;; (add-hook 'elixir-ts-mode-hook 'copilot)
  ;; (add-hook 'elixir-mode-hook 'copilot)
  ;; (add-hook 'prog-mode-hook 'copilot)
  (treesit-available-p 'elixir)
  (setq major-mode-remap-alist '((elixir-mode . elixir-ts-mode)))
  (add-to-list 'tree-sitter-langs--grammars
...
(custom-set-variables
 ...
 '(ignored-local-variable-values '((elixir-basic-offset . 2)))
 '(package-selected-packages
   '(ace-jump-helm-line ace-link aggressive-indent alchemist all-the-icons
                        auto-compile auto-highlight-symbol bui
                        centered-cursor-mode clean-aindent-mode
                        column-enforce-mode company dap-mode define-word devdocs
                        diminish dired-quick-sort disable-mouse dotenv-mode
                        drag-stuff dumb-jump elisp-def elisp-demos
                        elisp-slime-nav elixir-mode emr eval-sexp-fu evil-anzu
                        ...
                        eyebrowse fancy-battery flycheck flycheck-credo ggtags
                        ...
                        inspector link-hint lorem-ipsum lsp-docker lsp-mode
                        lsp-treemacs macrostep markdown-mode multi-line nameless
                        nerd-icons ob-elixir open-junk-file org-superstar
                        overseer paradox password-generator pcre2el popwin
                        quickrun rainbow-delimiters restart-emacs space-doc
